...
SoMTD::PlayButton::PlayButton(ijengine::Level *l) :
        m_menu_level(l)
{
        m_texture = ijengine::resources::get_texture("button/play_black.png");
        m_mouseover_texture = ijengine::resources::get_texture("button/play_white.png");
        m_x = 943;
        m_y = 380;
...
void
SoMTD::PlayButton::update_self(unsigned, unsigned)
{
}

bool
SoMTD::PlayButton::on_event(const ijengine::GameEvent& event)
{
...
void
SoMTD::PlayButton::draw_self(ijengine::Canvas *c, unsigned, unsigned)
{
        if (m_mouseover) {
...
void
SoMTD::PlayButton::draw_self_after(ijengine::Canvas *c, unsigned, unsigned)
{
}
