...
#ifndef GAME_INCLUDE_POSEIDON_TOWER_HPP_
#define GAME_INCLUDE_POSEIDON_TOWER_HPP_
...
namespace SoMTD {
class PoseidonTower : public Tower {
 public:
  PoseidonTower(int _x, int _y, int _level, Player* _player);
...
#endif  // GAME_INCLUDE_POSEIDON_TOWER_HPP_
